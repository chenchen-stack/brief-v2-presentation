...
window.AppData = {
  ...
  roles: {
    ...
    bizfin: {
      id: 'bizfin', name: '业务财务',
      desc: '资金流录入 · 计划编报 · 执行跟踪',
      pages: ['workbench','dashboard','cashflow','analysis','liquidity'],
    },
    admin: {
      id: 'admin', name: '系统管理员',
      desc: '基础数据 · 映射规则 · 集成配置 · 排障可阅单据与分析',
      pages: ['workbench','dashboard','cashflow','analysis','liquidity','basedata','integration'],
    },
  },
  ...
  navItems: [
    ...
    { group: '业务中心', items: [
      ...
      { id: 'cashflow',    icon: '💸', text: '资金流管理' },
      { id: 'analysis',    icon: '🔬', text: '资金流分析' },
      { id: 'liquidity',   icon: '📈', text: '资金流预测' },
    ]},
    { group: '系统配置', items: [
      { id: 'basedata',    icon: '🗂️', text: '基础数据' },
      { id: 'integration', icon: '🔗', text: '数据集成' },
    ]},
  ],
