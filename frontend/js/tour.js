    ...
    full: [
      {
        id: 'welcome',
        title: '欢迎使用「亿流」资金预测',
        body: '接下来用聚光灯带您走一遍主界面与核心闭环。可随时点「跳过」结束。',
        center: true,
      },
      {
        page: 'dashboard',
        ...
        title: '亿流 Work（协作）',
        body: '打开右侧协作工作台，可对话查询头寸、跳转页面、执行批量确认等。',
        placement: 'bottom',
      },
      {
        page: 'dashboard',
        ...
        title: '侧栏导航',
        body: '智能协作、业务中心（看板→单据→分析→预测）、系统配置（基础数据与集成）按组分区。',
        placement: 'right',
      },
      {
        page: 'dashboard',
      ...
      },
      {
        ...
        selector: '#dash-kpi',
        title: '总览 KPI',
        body: '点击 KPI 卡片可跳转到资金流或分析（演示联动）。',
        placement: 'bottom',
      },
      {
        page: 'cashflow',
        selector: '#cf-btn-fetch',
        title: '资金流 · 获取数据',
        body: '闭环第一步：拉取银企/集成数据；再「智能批量确认」，仅已确认进入分析。',
        placement: 'bottom',
      },
      {
        page: 'analysis',
        selector: '#an-btn-run',
        title: '资金流分析 · 运行分析',
        body: '选择维度与单位后运行，生成头寸图与明细表；下方 AI 报告可解读结果。',
        placement: 'bottom',
      },
      {
        page: 'liquidity',
        ...
        title: '资金流预测',
        body: '滚动预测与预算表在此；与已确认单据口径一致时可下钻科目。',
        placement: 'bottom',
      },
      {
        page: 'basedata',
      ...
      },
      {
        ...
        title: '数据集成',
        body: 'Excel 导入或模拟同步写入单据，与「资金流管理」共用同一套记录。',
        placement: 'bottom',
      },
      {
        id: 'done',
